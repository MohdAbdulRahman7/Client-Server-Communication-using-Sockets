...
* Mirror II - Server Connection - Port 7001
*
...
int main(int argc, char *argv[]) {
  int sockfd, newsockfd, portno = MIRROR2_PORT;    // socket fds -  individual client connections
  ...
  printf("Mirror2 is listening on port %d...\n", portno);
